...
unlocked to sign the BitcoinOil-Qt.app bundle.
...
allowing somebody to distribute a BitcoinOil-Qt.app or bitcoinoil-qt-setup.exe with a valid
...
that the bitcoinoil-qt.exe file inside the installer had not been tampered with.
