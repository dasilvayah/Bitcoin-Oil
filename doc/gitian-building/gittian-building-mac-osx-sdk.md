...
The script [extract-osx-sdk.sh](https://github.com/bitcoinoil/bitcoinoil-core/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
