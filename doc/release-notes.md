...
To receive security and update notifications, please subscribe to:
  ...
  <https://bitcoinoilcore.org/en/list/announcements/join/>
...
- `bitcoinoil-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries for the most
  common 32-bit ARM architecture.
- `bitcoinoil-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries for the most
