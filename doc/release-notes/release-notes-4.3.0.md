# BitcoinOil v4.3.0 Release Notes

## Introduces OpenAlias:

This PR https://github.com/BITCOINOIL/bitcoinoil-core/pull/213 completes the implementation of the OpenAlias protocol into the BitcoinOil Core client.
...
- BitcoinOil enforces by default the use of DNSSEC

### OpenAlias registration
You can now register a OpenAlias address at http://openalias.btco.community/
...
The secp256k1 lib from bitcoin 16.2 release was included into the codebase. While there are a number of improvements, the update was mainly needed due to the better build options for developers and allows newer OS's to build. This reduces the friction in getting setup and working with BitcoinOil
...
- New RPC command `resolveopenalias` resolves an OpenAlias address to a BitcoinOil address
