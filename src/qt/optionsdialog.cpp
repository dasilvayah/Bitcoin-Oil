    ...
    mapper(0)
{
    ...
    ui->bitcoinoilAtStartup->setToolTip(ui->bitcoinoilAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinoilAtStartup->setText(ui->bitcoinoilAtStartup->text().arg(tr(PACKAGE_NAME)));
