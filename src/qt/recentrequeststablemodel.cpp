    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return BitcoinOilUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, BitcoinOilUnits::separatorNever);
            else
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+BitcoinOilUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
