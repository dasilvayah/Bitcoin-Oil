...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(BitcoinOilUnits::BTCO),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = BitcoinOilUnits::formatWithUnit(unit, amount, true, BitcoinOilUnits::separatorAlways);
        if(!confirmed)
        {
                              ...
                              const CAmount& coldStakingBalance)
{
    ...
    ui->labelBalance->setText(BitcoinOilUnits::formatWithUnit(unit, balance, false, BitcoinOilUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BitcoinOilUnits::formatWithUnit(unit, unconfirmedBalance, false, BitcoinOilUnits::separatorAlways));
    ui->labelStaking->setText(BitcoinOilUnits::formatWithUnit(unit, stakingBalance, false, BitcoinOilUnits::separatorAlways));
    ui->labelColdStaking->setText(BitcoinOilUnits::formatWithUnit(unit, coldStakingBalance, false, BitcoinOilUnits::separatorAlways));
    ui->labelImmature->setText(BitcoinOilUnits::formatWithUnit(unit, immatureBalance, false, BitcoinOilUnits::separatorAlways));
    ui->labelTotal->setText(BitcoinOilUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, BitcoinOilUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(BitcoinOilUnits::formatWithUnit(unit, aRange[i++].Total, false, BitcoinOilUnits::separatorAlways));
    ui->label7dStakingStats->setText(BitcoinOilUnits::formatWithUnit(unit, aRange[i++].Total, false, BitcoinOilUnits::separatorAlways));
    ui->label30dStakingStats->setText(BitcoinOilUnits::formatWithUnit(unit, aRange[i++].Total, false, BitcoinOilUnits::separatorAlways));
    ui->label1yStakingStats->setText(BitcoinOilUnits::formatWithUnit(unit, aRange[i++].Total, false, BitcoinOilUnits::separatorAlways));
    ui->labelallStakingStats->setText(BitcoinOilUnits::formatWithUnit(unit, aRange[i++].Total, false, BitcoinOilUnits::separatorAlways));
}
