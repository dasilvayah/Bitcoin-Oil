 ...
 */
#ifndef BITCOINOIL_UTIL_H
#define BITCOINOIL_UTIL_H
...
extern const char * const BITCOINOIL_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinoil-%s", name);
