...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBitcoinOilAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBitcoinOilAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBitcoinOilAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBitcoinOilAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBitcoinOilAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcoinOilAddress(arr[0].get_str()).Get() == demoAddress.Get());
