...
const char * const BITCOINOIL_PID_FILENAME = "bitcoinoil.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BitcoinOil
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BitcoinOil
    // Mac: ~/Library/Application Support/BitcoinOil
    // Unix: ~/.bitcoinoil
#ifdef WIN32
    // Windows
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", BITCOINOIL_CONF_FILENAME));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No bitcoinoil.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override bitcoinoil.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", BITCOINOIL_PID_FILENAME));
