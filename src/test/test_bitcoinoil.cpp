...
#define BOOST_TEST_MODULE BitcoinOil Test Suite

#include "test_bitcoinoil.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitcoinoil_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
