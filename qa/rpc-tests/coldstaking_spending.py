...
class ColdStakingSpending(BitcoinOilTestFramework):
    ...
    def run_test(self):
        ...
        # get wallet balance and staking weight before sending some bitcoinoil
        ...
        """send bitcoinoil to our coldstaking address, grab balance & staking weight"""

        # send funds to the cold staking address (leave some nav for fees) -- we specifically require
        # a transaction fee of minimum 0.002884 bitcoinoil due to the complexity of this transaction
        ...
        # asserts if amount recieved is what it should be; ~59814699.99660530 BTCO
        ...
        # staking weight will be 0 as our recieved BLOCK_REWARD bitcoinoil isn't mature enough to count towards
        # our staking weight
