...
class CommunityFundCreatePaymentrequestRawTX(BitcoinOilTestFramework):
...
#            assert ("bad-cfund-payment-request" in e.error['message'])
    ...
    def send_raw_paymentrequest(self, amount, address, proposal_hash, description):
        ...
        message = "I kindly ask to withdraw " + str(amount) + "BTCO from the proposal " + proposal_hash + ". Payment request id: " + str(description)
