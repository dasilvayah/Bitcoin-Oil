...
class SendToAddressTest (BitcoinOilTestFramework):
    ...
    def run_test (self):
        ...
        # Generate necessary BTCO for transactions
        print("Mining blocks...")
        ...
        # Assert correct amount of BTCO generated
        ...
        try:
            ...
            if "Invalid BitcoinOil address" in e.error["message"]:
        ...
        try:
            ...
            if "Insufficient funds" in e.error["message"]:
                exception_assert = True
                # Not enought BTCO to make transaction
        assert(exception_assert)
        exception_assert = False
        try:
            ...
            if "Error: This transaction requires a transaction fee of at least 0.0001 because of its amount, complexity, or use of recently received funds!" in e.error["message"]:
                exception_assert = True
                # Try send entire balance, not enought BTCO to pay for fee
        assert(exception_assert)
        exception_assert = False
        try:
