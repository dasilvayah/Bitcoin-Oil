...
`qa/pull-tester/test_framework/test_framework.py:BitcoinOilTestFramework.main`.
...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_BITCOINOILD' not in vars():
    ENABLE_BITCOINOILD=0
...
#Set env vars
if "BITCOINOILD" not in os.environ:
    os.environ["BITCOINOILD"] = BUILDDIR + '/src/bitcoinoild' + EXEEXT
if "BITCOINOILCLI" not in os.environ:
    os.environ["BITCOINOILCLI"] = BUILDDIR + '/src/bitcoinoil-cli' + EXEEXT

if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/bitcoinoil/bitcoinoil/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/bitcoinoil/bitcoinoil/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_BITCOINOILD == 1):
    print("No rpc tests to run. Wallet, utils, and bitcoinoild must all be enabled")
    sys.exit(0)
